...
//
// Please let me know why this is not called a Declaration instead of a definition.
//
...
// Declaring a function
 function squarePrintFuncDef ( num1) {
             return  console.log(" The result is: " + num1 * num1);
  };

// Expressing a function
var squarePrintFuncExpress =  function (num1) {
      console.log( " The result is: " + num1 * num1);
 };
...
// Your code here.
function countLetters(string, lett) {
  var counted = 0;
  for (var num = 0; num < string.length; num++)
    if (string.charAt(num) == lett)
      counted += 1;
  return counted;
}

// Function Calls - DO NOT ALTER
console.log( countLetters("BBC", "B") );
// → 2
console.log( countLetters("kakkerlak", "k") );
// → 4
console.log( countLetters("michael", "M") );
// → 0
